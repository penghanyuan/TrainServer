...
/**
 * Created by vivid on 2016/5/4.
 */
@Component("androidPush")
public class MyAndroidPush {
    //定义常量, appId、appKey、masterSecret 采用本文档 "第二步 获取访问凭证 "中获得的应用配置
    private static String appId = "qrOE7ZrS6D7ivXWNwbuon4";
    private static String appKey = "wEsqZG86ha8TAD5yNbxi7A";
    private static String masterSecret = "crUHe4lo338EqfIEy5yve2";
